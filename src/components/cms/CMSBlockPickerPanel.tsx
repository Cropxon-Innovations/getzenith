...
export const CMSBlockPickerPanel = forwardRef<HTMLDivElement, CMSBlockPickerPanelProps>(
  ({ isOpen, onClose, onInsertBlock, userRole = 'tenant_admin' }, ref) => {
...
CMSBlockPickerPanel.displayName = 'CMSBlockPickerPanel';
